	...
	<h2>{PLUGIN_TITLE}</h2>
		<div>
			<form id="search" name="search" action="{PLUGIN_SEARCH_ACTION}" method="get">
				...
				<div class="tagsbox">
					<p class="centerall"><strong>{PHP.L.plu_search_req}:</strong> {PLUGIN_SEARCH_TEXT} <input type="submit" class="btn" value="{PHP.L.plu_search_key}" /></p>
					<p class="centerall">
				...
				<div class="tagsbox">
					<p class="centerall"><strong>{PHP.L.plu_other_date}:</strong></p>
					<p class="centerall">{PLUGIN_SEARCH_DATE_SELECT}</p>
					<p class="centerall">{PLUGIN_SEARCH_DATE_FROM}</p>
					<p class="centerall">-</p>
					<p class="centerall">{PLUGIN_SEARCH_DATE_TO}</p>
					<p class="centerall">{PHP.L.plu_other_userfilter}: {PLUGIN_SEARCH_USER}</p>
				</div>
