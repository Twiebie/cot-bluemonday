...
<!-- END: BEFORE_AJAX -->
	...
	<div class="largeblock">
		...
		<p class="paging">
			<span class="btn">{PM_INBOX}</span><span class="spaced">{PHP.cfg.separator}</span><span class="btn">{PM_SENTBOX}</span><span class="spaced">{PHP.cfg.separator}</span><span class="btn">{PM_SENDNEWPM}</span><br />
...
<!-- END: PM_ROW_EMPTY -->
			...
			<p class="paging">
				...
				<button type="submit" class="btn" name="delete">{PHP.L.Confirm}</button>
			</p>
